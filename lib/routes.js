module.exports = {
    ...
    "issues": {
        ...
        "lock": {
            "url": "/repos/:user/:repo/issues/:number/lock",
            "method": "PUT",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "add-assignees-to-issue": {
            "url": "/repos/:user/:repo/issues/:number/assignees",
            "method": "POST",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-events-timeline": {
            "url": "/repos/:user/:repo/issues/:number/timeline",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "update-label": {
            "url": "/repos/:user/:repo/labels/:oldname",
            "method": "PATCH",
            "params": {
                "$user": null,
                "$repo": null,
    ...
    "reactions": {
        ...
        "get-for-issue": {
            "url": "/repos/:user/:repo/issues/:number/reactions",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-for-issue-comment": {
            "url": "/repos/:user/:repo/issues/comments/:id/reactions",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-for-pull-request-review-comment": {
            "url": "/repos/:user/:repo/pulls/comments/:id/reactions",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
    ...
    "repos": {
        ...
        "get-protected-branch-required-status-checks": {
            "url": "/repos/:user/:repo/branches/:branch/protection/required_status_checks",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "update-protected-branch-required-status-checks": {
            ...
            "params": {
                ...
                "body": {
                    ...
                    "validation": "",
                    "invalidmsg": "",
                    "description": "JSON object that contains the following keys: `include_admins` - Enforce required status checks for repository administrators, `strict` - Require branches to be up to date before merging, `contexts` - The list of status checks to require in order to merge into this branch."
                },
                "$page": null,
                "$per_page": null
            },
        ...
        "get-protected-branch-required-status-checks-contexts": {
            "url": "/repos/:user/:repo/branches/:branch/protection/required_status_checks/contexts",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-protected-branch-restrictions": {
            "url": "/repos/:user/:repo/branches/:branch/protection/restrictions",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-protected-branch-team-restrictions": {
            "url": "/repos/:user/:repo/branches/:branch/protection/restrictions/teams",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-protected-branch-user-restrictions": {
            "url": "/repos/:user/:repo/branches/:branch/protection/restrictions/users",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-invites": {
            "url": "/repositories/:repo/invitations",
            "method": "GET",
            "params": {
                "$repo": null
            },
        ...
        "delete-invite": {
            "url": "/repositories/:repo/invitations/:id",
            "method": "DELETE",
            "params": {
                "$repo": null,
                "$id": null
        ...
        "get-pages-build": {
            "url": "/repos/:user/:repo/pages/builds/:id",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
            ...
            "description": "Get a specific Pages build"
        },
        ...
        "get-project": {
            "url": "/repos/:user/:repo/projects/:number",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-project-columns": {
            ...
            "description": "List a project's columns."
        },

        "get-project-column": {
            "url": "/repos/:user/:repo/projects/columns/:id",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "move-project-column": {
            "url": "/repos/:user/:repo/projects/columns/:id/moves",
            "method": "POST",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-project-cards": {
            "url": "/repos/:user/:repo/projects/columns/:id/cards",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-project-card": {
            "url": "/repos/:user/:repo/projects/columns/cards/:id",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "move-project-card": {
            "url": "/repos/:user/:repo/projects/columns/cards/:id/moves",
            "method": "POST",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-referrers": {
            "url": "/repos/:user/:repo/traffic/popular/referrers",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-paths": {
            "url": "/repos/:user/:repo/traffic/popular/paths",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-views": {
            "url": "/repos/:user/:repo/traffic/views",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
        ...
        "get-clones": {
            "url": "/repos/:user/:repo/traffic/clones",
            "method": "GET",
            "params": {
                "$user": null,
                "$repo": null,
    ...
    "users": {
        ...
        "accept-repo-invite": {
            "url": "/user/repository_invitations/:id",
            "method": "PATCH",
            "params": {
                "$id": null
            },
